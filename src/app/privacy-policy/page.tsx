...
export const metadata: Metadata = {
    title: "Политика обработки персональных данных — ВИБРО-ЛАЗЕР",
    description: "Документ о конфиденциальности и обработке персональных данных ВИБРО-ЛАЗЕР.",
    alternates: {
...
export default function PrivacyPolicy() {
    const origin = `https://вибро-лазер.рф/`;
    return (
        <>
                ...
                <div className="container">
                    <div className={styles.content}>
                        ...
                        <section className={styles.section}>
                            <h2 className={clsx(styles.h2, styles.h2_mt0)}>1. Общие положения</h2>
                            <p className={styles.bold}>
                                ...
                                «КСК-СИСТЕМС», ОГРН: 1117847079261, ИНН: 7841441038 (далее — Оператор).
                            </p>
                        ...
                        <section className={styles.section}>
                            <h2 className={styles.h2}>3. Основные права и обязанности Оператора</h2>
                        ...
                        <section className={styles.section}>
                            <h2 className={styles.h2}>5. Принципы обработки персональных данных</h2>
                        ...
                        <section className={styles.section}>
                            <h2 className={styles.h2}>6. Цели обработки персональных данных</h2>
                                ...
                                <div className={styles.table}>
                                    ...
                                    <div className={styles.row}>
                                        ...
                                        <div className={styles.cell}>
                                            <ul>
                                                <li>
                                                    Идентификатор пользователя, хранимый в
                                                    cookie-файла
                                                </li>
                        ...
                        <section className={styles.section}>
                            <h2 className={styles.h2}>7. Условия обработки персональных данных</h2>
                            <ul>
                                <li>
                        ...
                        <section className={styles.section}>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    Оператора info@vibro-laser.com с пометкой «Актуализация персональных
                                    данных».
                                </li>
                                <li>
                                    8.4. Срок обработки персональных данных определяется достижением
                                    целей, для которых были собраны персональные данные, за
                                    исключением cookie-файлов (срок хранения – до 1 года). <br />
                                    ...
                                    info@vibro-laser.com с пометкой «Отзыв согласия на обработку
                                    персональных данных».
                                </li>
                                <li>
                        ...
                        <section className={styles.section}>
                            ...
                            <ul>
                                <li>
                                    11.1. Трансграничная передача персональных данных Оператором не
                                    осуществляется.
                                </li>
                            </ul>
                        </section>
                        <section className={styles.section}>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    в сети Интернет по адресу {origin}privacy-policy
                                </li>
                            </ul>
                        </section>
                    </div>
